...
<section class="content-header">
    ...
    <section class="content container-fluid">
         <section class="content">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="POST" action="{{route('product.update', ['product' => $product->product_id])}}">
                @csrf
                @method('PATCH')
              <div class="box-body">
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="name" class="col-sm-3 control-label">Names</label>
                      <div class="col-sm-9">
                        <input type="text" name="name" class="form-control" id="name" placeholder="Product Name" value="{{$product->name ? $product->name : old('name') }}">
                        @error('name')
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        ...
                        <label>
                            <input class="form-check-input" type="checkbox" name="under_vat" for="under_vat" id="under_vat" {{ $product->under_vat == 'on' ? 'checked' : '' }}>
                            Under VAT
                        </label>
                    </div>
                      </div>
...
{{--
              ...
              <div class="box-footer">
                ...
                <button type="submit" class="btn btn-default">Cancel</button>
                <button type="submit" class="btn btn-default">Cancel</button> --}}
                <button type="submit" class="btn btn-info pull-left">Update Products</button>
              </div>
              <!-- /.box-footer -->
            </form>
          </div>
