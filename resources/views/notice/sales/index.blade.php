...
<section class="content-header">
    ...
    <section class="content container-fluid">
         <section class="content">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="POST" action="{{route('store-sales-notice')}}" id="invoice-form" >
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                             <input type="text" name="invoice_num" class="form-control" id="invoice_num" placeholder="Invoice Number" value="{{old('invoice_num') ? old('invoice_num') : ''}}">
                              @error('invoice_num')
                                <div class="text-danger">
              ...
              <div class="box-footer">
                ...
                <button type="submit" class="btn btn-default">Cancel</button>
                <button type="submit" class="btn btn-default">Cancel</button> --}}
                <button type="submit" class="btn btn-info pull-right" id="save-invoice-btn">Save Delivery Notice</button>
              </div>
              <!-- /.box-footer -->
            </form>
          </div>
      ...
      <div class="row">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Uninvoiced Sales</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table class="table table-bordered table-striped">
                ...
                <tbody>
                    @foreach ($sales_delivery_notice as $invoice)
                    <tr class="single-row" data-target="{{$invoice->id}}">
                      ...
                      <td data-target="{{$invoice->id}}">
                        <form action="{{route('sales-notice-action')}}" method="POST">
                          @csrf
                        <button data-target="{{$invoice->invoice_id}}" class="view_invoice btn btn-primary" name="generate">Generate Invoice</button>
                        <input type="hidden" name="invoice_id" value="{{$invoice->invoice_id}}">
                        <button type="submit" data-target="{{$invoice->invoice_id}}" class="btn btn-warning" name="edit">Edit</button>
                        <button type="submit" data-target="{{$invoice->invoice_id}}" class="btn btn-danger" name="delete">Delete</button>
                        </form>
                      </td>
