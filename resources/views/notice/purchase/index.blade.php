...
<section class="content-header">
    ...
    <section class="content container-fluid">
         <section class="content">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="POST" action="{{route('store-purchase-notice')}}" id="invoice-form" >
                @csrf
      ...
      <div class="row">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Uninvoiced Purchases</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table class="table table-bordered table-striped">
                ...
                <tbody>
                    @foreach ($purchase_delivery_notice as $invoice)
                    <tr class="single-row" data-target="{{$invoice->id}}">
                      ...
                      <td>{{$invoice->truck_num}}</td>
                       <td data-target="{{$invoice->id}}">
                        <form action="{{route('purchase-notice-action')}}" method="POST">
                          @csrf
                      ...
                      {{-- <td data-target="{{$invoice->id}}"><button data-target="{{$invoice->invoice_id}}" class=" view_invoice btn btn-primary" >Generate Invoice</button></td> --}}
                    ...
                    <tfoot>
                        <div style="margin-top:20px">
                            <div class="pull-right">
                                {{$purchase_delivery_notice->links()}}
                            </div>
                        </div>
                    </tfoot>
            </div>
    ...
    <div class="modal fade" id="purchase-items">
        <div class="modal-dialog modal-full modal-dialog-scrollable">
          <div class="modal-content">
              <form method="post" action="{{route('generate-purchase-invoice')}}">
                @csrf
...
let products = [];
       $.ajax({
        ...
        const computeDependentValues = (evt) =>{
          ...
          const watcher = ['quantity_observed','coefficient']
...
$('#purchase-items').on('hidden.bs.modal', function (e) {
    document.getElementById('invoice-items').innerHTML=``;
        ...
        $('.price').on('change', computeDependentValues);
        ...
        const fetchInvoiceItems = (evt) => {
            ...
            $.ajax({
                url: '/api/get-purchase-notice-details',
