...
<section class="content-header">
    ...
    <section class="content container-fluid">
         <section class="content">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="POST" action="{{route('edit-invoice',['invoice_id' => $invoice->invoice_id])}}">
                @csrf
                ...
                <div class="row">
                      ...
                      <div class="col-sm-9">
                          <select class="form-control" name="customer_id" id="customer_id">
                            ...
                            @foreach ($customers as $customer)
                                <option value="{{$customer->id}}" {{$invoice->customer->id == $customer->id ? 'selected' : ''}} data-sup-data="{{json_encode($customer->account_number)}}">{{$customer->customer_name_english}}</option>
                            @endforeach
                          </select>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="customer_account" class="form-control" id="customer_account" placeholder="Customer Account Details" value="{{ $invoice->customer_account ? $invoice->customer_account : old('customer_account')}}">
              ...
              <div class="box-footer">
                ...
                <button type="submit" class="btn btn-default">Cancel</button>
                <button type="submit" class="btn btn-default">Cancel</button> --}}
                <button type="submit" class="btn btn-info pull-right" >Add Invoice</button>
              </div>
              <!-- /.box-footer -->
            </form>
          </div>
