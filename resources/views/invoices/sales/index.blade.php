...
<section class="content-header">
    ...
    <section class="content container-fluid">
         <section class="content">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="POST" action="{{route('invoice.sales.store')}}" id="invoice-form" >
                @csrf
                <input type="hidden" name="items" id="items">
                {{-- <input type="hidden" name="vat_num" id="vat_num"> --}}
              <div class="box-body">
                <div class="row">
                  <div class="col-md-6">
                      ...
                      <div class="col-sm-9">
                          <select class="form-control" name="customer_id" id="customer_id">
                            ...
                            @foreach ($customers as $customer)
                                <option value="{{$customer->id}}" {{old('customer_id') == $customer->id ? 'selected' : ''}} data-sup-data="{{json_encode($customer->account_number)}}">{{$customer->customer_name_english}}</option>
                            @endforeach
                          </select>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="customer_account" class="form-control" id="customer_account" placeholder="Customer Account Details" value="{{old('customer_account') ? old('customer_account') : ''}}">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                              <input type="number" name="vat_num" id="vat_num" class="form-control" placeholder="VAT NUMBER" value="{{old('vat_num') ? old('vat_num') : ''}}" disabled>
      ...
      <div class="row">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Sales Invoices Unpaid</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table class="table table-bordered table-striped">
                ...
                <tbody>
                    @foreach ($sales_invoices_unpaid as $invoice)
                    <tr class="single-row" data-target="{{$invoice->id}}">
                      <form method="post" action="{{route('invoice-actions')}}">
                        @csrf
                      <input type="hidden" name="invoice_id" value="{{$invoice->invoice_id}}">
                      <td>{{$invoice->id}}</td>
                      <td>{{$invoice->customer->customer_name_english}}</td>
      ...
      <div class="row">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Sales Invoices Paid</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table class="table table-bordered table-striped">
                ...
                <tbody>
                    @foreach ($sales_invoices_paid as $invoice)
                    <tr class="single-row" data-target="{{$invoice->id}}">
    ...
    <div class="modal fade" id="purchase-items">
        <div class="modal-dialog modal-full modal-dialog-scrollable">
          <div class="modal-content">
            <form action="/print/invoice/sales" method="POST" >
              @csrf
              ...
              <div class="modal-footer">
                  <div class="pull-right">
                    <button type="submit" name="print" class="btn btn-primary" >Print</button>
                      <button type="submit" class="btn btn-primary" name="generate_receipt" id="gen_receipt">Generate Receipt</button>
    ...
    let products = [];
       $.ajax({
        ...
        const computeDependentValues = (evt) =>{
          ...
          const watcher = ['quantity_observed','coefficient','price_vat','price'];
        ...
        $('#save-invoice-btn').on('click',(e) => {
          ...
          const fields = ['product_name','compartment','quantity_observed','coefficient','quantity_15deg', 'price_vat','price','currency','amount'];
          let fObj = [];
          let hasError = false;
