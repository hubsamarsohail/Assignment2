                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="name" class="form-control" id="name" placeholder="Vechile Name" value="{{old('name') ? old('name') : ''}}">
                        @error('name')
      ...
      <div class="row">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Registered Vechile's List</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr class="single-row" data-target="{{$vechile->vechile_id}}">
                      <td>{{$vechile->id}}</td>
                      <td>{{$vechile->brand}}</td>
                      <td>{{$vechile->plate_number}}</td>
                      <td>{{$vechile->capacity}}</td>
                      <td>{{$vechile->num_compartments}}</td>
                    </tr>
                  @endforeach
                </tbody>
                </table>
  ...
  $(function () {
    ...
    // })
        ...
        $('.single-row').on('click', function(evt){
            ...
            window.location = `/vechile/${target}`;
        })
